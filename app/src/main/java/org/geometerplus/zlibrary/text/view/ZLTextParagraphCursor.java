...
public final class ZLTextParagraphCursor {
    ...
    final org.geometerplus.zlibrary.text.view.CursorManager CursorManager;
    ...
    ZLTextParagraphCursor(org.geometerplus.zlibrary.text.view.CursorManager cManager, ZLTextModel model, int index) {
