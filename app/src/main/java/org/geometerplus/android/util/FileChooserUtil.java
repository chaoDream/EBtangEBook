...
public abstract class FileChooserUtil {
    ...
    public static void runFolderListDialog(Activity activity, int requestCode, String title, String fileChooserTitle, List<String> initialValue, boolean chooseWritableDirsOnly) {
