...
public abstract class NetworkLibraryActivity extends TreeActivity<NetworkTree> implements ListView.OnScrollListener, NetworkLibrary.ChangeListener {
    ...
    private List<? extends Action> getContextMenuActions(NetworkTree tree) {
        return tree instanceof NetworkBookTree ? NetworkBookActions.getContextMenuActions(this, (NetworkBookTree) tree, BookCollection, Connection) : myContextMenuActions;
    }
    ...
    private void updateLoadingProgress() {
        ...
        setProgressBarIndeterminateVisibility(library.isUpdateInProgress() ||
    ...
    private final BroadcastReceiver myCatalogInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            final List<String> urls = getResultExtras(true).getStringArrayList("fbreader.catalog.ids");
    ...
    public void requestCatalogPlugins() {
        sendOrderedBroadcast(new Intent(Util.EXTRA_CATALOG_ACTION), null, myCatalogInfoReceiver, null, RESULT_OK, null, null);
    }
}
