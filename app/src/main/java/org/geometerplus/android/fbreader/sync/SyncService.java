...
public class SyncService extends Service implements IBookCollection.Listener<Book> {
    ...
    private final SyncNetworkContext myBookUploadContext = new SyncNetworkContext(this, mySyncOptions, mySyncOptions.UploadAllBooks);
    private final SyncNetworkContext mySyncPositionsContext = new SyncNetworkContext(this, mySyncOptions, mySyncOptions.Positions);
    private final SyncNetworkContext mySyncBookmarksContext = new SyncNetworkContext(this, mySyncOptions, mySyncOptions.Bookmarks);
    ...
    private static final class Hashes {
        ...
        public String toString() {
            return String.format("%s/%s HASHES (%s)", Actual.size(), Deleted.size(), Initialised ? "complete" : "partial");
        }
    }
