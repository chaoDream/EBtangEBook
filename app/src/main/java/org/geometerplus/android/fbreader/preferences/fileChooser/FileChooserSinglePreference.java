...
class FileChooserSinglePreference extends FileChooserPreference {
    ...
    protected void onClick() {
        FileChooserUtil.runDirectoryChooser((Activity)getContext(), myRequestCode, myResource.getResource("chooserTitle").getValue(), getStringValue(), myChooseWritableDirectoriesOnly);
    }
