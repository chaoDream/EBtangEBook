...
public abstract class DictionaryUtil {
    ...
    public static final ZLEnumOption<DurationEnum> TranslationToastDurationOption = new ZLEnumOption<DurationEnum>("Dictionary", "TranslationToastDuration", DurationEnum.duration40);
    public static final ZLEnumOption<DurationEnum> ErrorToastDurationOption = new ZLEnumOption<DurationEnum>("Dictionary", "ErrorToastDuration", DurationEnum.duration5);
    ...
    private static Map<PackageInfo, Integer> ourInfos = Collections.synchronizedMap(new LinkedHashMap<PackageInfo, Integer>());
    ...
    public static PackageInfo getCurrentDictionaryInfo(boolean singleWord) {
        final ZLStringOption option = singleWord ? singleWordTranslatorOption() : multiWordTranslatorOption();
