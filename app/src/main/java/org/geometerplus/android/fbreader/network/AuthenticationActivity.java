...
public class AuthenticationActivity extends Activity {
    ...
    private static final Map<Long, Runnable> ourOnSuccessRunnableMap = Collections.synchronizedMap(new HashMap<Long, Runnable>());
    ...
    private void finishOk(String username, String password) {
        final ZLNetworkManager.CredentialsCreator creator = ZLNetworkManager.Instance().getCredentialsCreator();
        if (creator != null) {
