...
public final class FBView extends ZLTextView {
    ...
    public boolean onTrackballRotated(int diffX, int diffY) {
        ...
        final ZLViewEnums.Direction direction = (diffY != 0) ? (diffY > 0 ? ZLViewEnums.Direction.down : ZLViewEnums.Direction.up) : (diffX > 0 ? ZLViewEnums.Direction.leftToRight : ZLViewEnums.Direction.rightToLeft);
