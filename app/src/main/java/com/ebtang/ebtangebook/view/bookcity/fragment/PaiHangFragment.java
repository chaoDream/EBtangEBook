...
public class PaiHangFragment extends BaseFragment{
    ...
    private LinearLayout linearLayout_more_new,linearLayout_more_fans;
    ...
    public void initView() {
        ...
        linearLayout_more_new = (LinearLayout)linearLayout_new.findViewById(R.id.book_paihang_more);
        linearLayout_more_fans = (LinearLayout)linearLayout_fans.findViewById(R.id.book_paihang_more);
        setCliclListener();
    }
